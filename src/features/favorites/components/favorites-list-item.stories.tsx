...
export const Workshop: ComponentStory<typeof FavoritesListItem> = args => (
  <FavoritesListItem
    {...args}
    product={{ ...AUDIO_PRODUCT, itemType: 'WorkshopProduct', venueName: 'Workshop Venue Name' }}
  />
)
