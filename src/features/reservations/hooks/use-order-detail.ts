...
export const useOrderDetail = (orderCode: Order['code'], userId: User['uid'] = 'current') => {
  const baseSiteId = useSelector(getCommerceBaseSiteId)

  return commerceApi.endpoints.getOrderDetail.useQuery(
    { baseSiteId, userId, orderCode },
