...
import { getLastShownTimestamp, getShowInAppReview } from '../in-app-review-selectors'
...
export const showInAppReview = createThunk<void, void>('inAppReview/showReview', async (_payload, thunkAPI) => {
  ...
  const lastShownTimestamp = getLastShownTimestamp(store)
