...
/**
 * This method can be used make an asyncThunk control the loading state inside a reducer, depending on the current state
 * of the asyncThunk (pending / fulfilled / rejected).
 */
export const addIsLoadingAsyncThunkCases = <State extends {}>(
